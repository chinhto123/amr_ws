...
def straighten(model_pose, gazebo_model_name):
    ...
    controller.move_to(x+0.1237381191319097

, y-0.12390850682057422

, target_quat=approach_quat-0.17)
...
if __name__ == "__main__":
    ...
    for model_name, model_pose in legos:
        ...
        controller.move_to(x+0.1252591604616369

, y-0.12385853802407666

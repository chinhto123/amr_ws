...
def straighten(model_pose, gazebo_model_name):
    ...
    controller.move_to(x, y-0.05, target_quat=approach_quat-0.17)
...
if __name__ == "__main__":
    ...
    for model_name, model_pose in legos:
        ...
        controller.move_to(x, y-0.05, target_quat=DEFAULT_QUAT * PyQuaternion(axis=[0, 0, 1], angle=math.pi / 2))

...
set(MSG_I_FLAGS "-Iur5_notebook:/home/chinh/autoxing/src/UR5-Pick-and-Place/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/chinh/autoxing/src/UR5-Pick-and-Place/msg/blocks_poses.msg" NAME_WE)
add_custom_target(_ur5_notebook_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_notebook" "/home/chinh/autoxing/src/UR5-Pick-and-Place/msg/blocks_poses.msg" ""
)

get_filename_component(_filename "/home/chinh/autoxing/src/UR5-Pick-and-Place/msg/Tracker.msg" NAME_WE)
add_custom_target(_ur5_notebook_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_notebook" "/home/chinh/autoxing/src/UR5-Pick-and-Place/msg/Tracker.msg" ""
)
...
_generate_msg_cpp(ur5_notebook
  "/home/chinh/autoxing/src/UR5-Pick-and-Place/msg/blocks_poses.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ur5_notebook
)
_generate_msg_cpp(ur5_notebook
  "/home/chinh/autoxing/src/UR5-Pick-and-Place/msg/Tracker.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/ur5_notebook
)

...
set(MSG_I_FLAGS "-Iur5_notebook:/home/chinh/autoxing/src/ur5_ROS-Gazebo-Melodic/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
add_custom_target(_ur5_notebook_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_notebook" "/home/chinh/autoxing/src/ur5_ROS-Gazebo-Melodic/msg/blocks_poses.msg" ""
)

get_filename_component(_filename "/home/chinh/autoxing/src/ur5_ROS-Gazebo-Melodic/msg/Tracker.msg" NAME_WE)
add_custom_target(_ur5_notebook_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ur5_notebook" "/home/chinh/autoxing/src/ur5_ROS-Gazebo-Melodic/msg/Tracker.msg" ""
)

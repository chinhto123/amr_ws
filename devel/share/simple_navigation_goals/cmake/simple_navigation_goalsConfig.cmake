...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/chinh/autoxing/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/chinh/autoxing/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/chinh/autoxing/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'chinh <chinh@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chinh/autoxing/src/simple_navigation_goals/${idir}'.  ${_report}")
    endif()
